function F = SimplifiedCalibrationFunction(X, THETA, v_NDI_tip2ref, mode, correction_flag, encoder1_LUT, encoder2_LUT, encoder3_LUT,encoder5_LUT)
    N = size(THETA, 2);

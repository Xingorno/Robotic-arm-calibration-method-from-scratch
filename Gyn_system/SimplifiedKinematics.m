...
% function [v_tip2base_matrix, v_tip2base_separate] = SimplifiedKinematics(LENGTH,THETA, A_coeff,B_coeff, PHI)
    function [m_tip2base] = SimplifiedKinematics(LENGTH, THETA, PHI, Coeff, correction_flag, encoder1_LUT, encoder2_LUT,encoder3_LUT, encoder5_LUT)
    ...
    for i = 1:N
        Theta = THETA(:,i);
        [theta1, theta2, theta3, theta4, theta5, theta6, theta7] = THETA_Transform(Theta, PHI, Coeff, correction_flag, encoder1_LUT, encoder2_LUT, encoder3_LUT,encoder5_LUT);
...
% Theta: 7*1
    function [theta1, theta2, theta3, theta4, theta5, theta6, theta7] = THETA_Transform(Theta, PHI, Coeff, correction_flag, encoder1_LUT, encoder2_LUT,encoder3_LUT, encoder5_LUT) 
...
%                 theta1 = LookupTable(Theta(1)*180/pi, encoder1_LUT.lookup_table_unique + 370*360/4096);
...
%                 theta3 = 0.0033 + 0.9818*Theta(3);
                theta3 = LookupTable(Theta(3)*180/pi, encoder3_LUT.lookup_table_unique);
